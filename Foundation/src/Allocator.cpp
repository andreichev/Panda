...
void *alloc(AllocatorI *allocator, size_t size, const char *file, uint32_t line) {
    return allocator->realloc(NULL, size, file, line);
}

void free(AllocatorI *allocator, void *ptr, const char *file, uint32_t line) {
    allocator->realloc(ptr, 0, file, line);
}

void *realloc(AllocatorI *allocator, void *ptr, size_t size, const char *file, uint32_t line) {
