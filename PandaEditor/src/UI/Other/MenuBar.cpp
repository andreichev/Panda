...
void MenuBar::onImGuiRender() {
    ...
    if (ImGui::BeginMenuBar()) {
        if (ImGui::BeginMenu("File")) {
            if (ImGui::MenuItem("Save World", NULL)) { m_output->menuBarSaveWorld(); }
            if (ImGui::MenuItem("Open Project", NULL)) { m_output->menuBarOpenProject(); }
            ...
            ImGui::Separator();
            if (ImGui::MenuItem("Exit", NULL)) { m_output->menuBarCloseApp(); }
            ImGui::EndMenu();
        }
